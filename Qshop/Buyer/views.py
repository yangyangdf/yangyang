...
def carList(request):
    ...
    for goods in goodList:
        id =goods.goods_id
        g=Goods.objects.get(id=id)
        img=g.image_set.first().img_adress.url.replace("media", "static")
...
def error(request):
    return HttpResponseRedirect("/buyer/404")
...
def Pay(order_id,money):
    alipay_public_key_string = '''-----BEGIN PUBLIC KEY-----
        
    -----END PUBLIC KEY-----'''

    app_private_key_string = '''-----BEGIN RSA PRIVATE KEY-----
        
    -----END RSA PRIVATE KEY-----'''

    alipay = AliPay(
        appid="2016092400586015",  # 支付宝app的id
        app_notify_url="",  # 回调视图
